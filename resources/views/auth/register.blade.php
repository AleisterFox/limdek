  ...
  <main>
    <section id="login">
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <input type="password" name="password_confirmation" id="confirm-password" placeholder="Confirmar contraseña">
        <button type="submit" class="button__secondary">Crear</button>
      </form>
